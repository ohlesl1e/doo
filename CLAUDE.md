...
The ontology (`ONTOLOGY.md`) design is complete: all six steps drafted, all three originally-open questions resolved (Asset / TrustBoundary / Payload), 50 ADRs recorded. `TrustBoundary` inference (capability + tenant) shipped in slice 3.
